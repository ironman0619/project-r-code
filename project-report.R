...
# Read in the match data files, combine them into a single dataframe
raw_matches <- files %>%
...
# Handle missing values in ranks and recalculate the data
...
# Define a split date to divide data into training and testing sets
